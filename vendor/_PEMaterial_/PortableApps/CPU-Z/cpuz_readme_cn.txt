...
ÁªÏµÎÒÃÇ £ºcpuz@cpuid.com
Web page: https://www.cpuid.com/cpuz.php
ÍøÕ¾£ºhttps://www.cpuid.com/cpuz.php
Validation page : https://valid.x86.fr/
È·ÈÏÒ³Ãæ £ºhttps://valid.x86.fr/
Hall of Fame : https://valid.x86.fr/records.php
ÃûÈËÌÃ :https://valid.x86.fr/records.php
CPUID SDK : http://www.cpuid-pro.com/devkits.php
CPUID SDK½éÉÜ £ºhttp://www.cpuid-pro.com/products-services.php
...
ÅäÖÃÎÄ¼þ±ØÐë´æ·ÅÔÚcpuz.exe. Í¬Ò»ÎÄ¼þ¼ÐÏÂÃû×ÖÎªcpuz.ini
...
- TextFontName : Font used for the information boxes. ÐÅÏ¢¿ò×ÖÌåÑùÊ½
- TextFontSize : Size of the font used for the information boxes. ÐÅÏ¢¿ò×ÖÌå´óÐ¡
- TextFontColor : Color of the font used for the information boxes. Value is expressed in hexadecimal, and consists in a classic Red/Green/Blue color code : RRGGBB ÐÅÏ¢¿òÊ¹ÓÃ×ÖÌåÑÕÉ«¡£RBGÑÕÉ«£ºRRGGBB/000060
- LabelFontName : Font used for the label boxes. ±êÇ©¿ò×ÖÌåÑùÊ½
- LabelFontSize : Size of the font used for the label boxes. ±êÇ©¿ò×ÖÌå´óÐ¡
- Sensor : Set to OFF (or 0) disables sensor chip detection and voltages measurement. 1 to enable.´«¸ÐÆ÷¼ì²âÉèÖÃ£¬1Îª¿ªÆô¡¢0Îª¹Ø±Õ ¹Ø±Õºó½«²»ÏÔÊ¾ÎÂ¶È¼°µçÑ¹
- PCI : Set to OFF (or 0) disables the PCI information. This disables chipset, SPD and, depending on the hardware, sensoring information. 1 to enable.PCI¼ì²âÉèÖÃ£¬1Îª¿ªÆô¡¢0Îª¹Ø±Õ ¹Ø±Õºó½«²»»áÏÔÊ¾Ö÷°å¡¢SPD¼°Ó²¼þ´«¸ÐÆ÷ÐÅÏ¢
- MaxPCIBus : Sets the maximum PCI bus to scan. Default value is 256.	
- DMI : Set to OFF (or 0) disables the DMI (Desktop Management Interface) information. This concerns BIOS vendor and version, motherboard vendor and revision. 1 to enable. DMIÉèÖÃ£¬1Îª¿ªÆô¡¢0Îª¹Ø±Õ¡£¹Ü±Úºñ
...
F5 £º±£´æµ±Ç°Ò³ÃæÎªbmpÎÄ¼þ
F6 : save the current tab in the clipboard
F6 £º±£´æµ±Ç°Ò³ÃæÔÚ¼ôÌù°åÖÐ
...
Cache Latency ToolÏÂÔØµØÖ· £ºhttp://download.cpuid.com/misc/latency.zip
...
--------------------------------------------------------------------------------------------------
1.21 -  January 2004
- one file package 	Ò»¸öÎÄ¼þ°ü
- Windows 64 support	Ö§³ÖWindows64Î»²Ù×÷ÏµÍ³
- new chipsets support	ÐÂÖ÷°åÖ§³Ö
- new CPU support : Celeron M, Pentium 4 "Prescott" ÐÂCPUÖ§³Ö£ºÈüÑï M£¬±¼ÌÚ4 "Prescott"

--------------------------------------------------------------------------------------------------
1.20a -  October 2003
- memory frequency and ratio on nForce2 
- KT600 support Ôö¼Ó¶ÔÍþÊ¢KT600Ð¾Æ¬×éÖ§³Ö
- W83627THF VRM mode
- SPD read improvement SPD
- Fix some memory leaks (DMI) ÐÞ¸´Ò»Ð©ÄÚ´æDMIÐÅÏ¢
- Fix memory size report ÐÞ¸´ÄÚ´æ´óÐ¡±¨¸æ
- Fix AGP side band status ÐÞ¸´AGP´ø¿í×´Ì¬
