...
@copy /y "X:\Users\ept\pack.7zf" "%Spath%:\FirPE\Resource\%w:~1,-2%" >nul
if not exist "%Spath%:\FirPE\Resource\%w:~1,-2%" pecmd file "X:\Users\ept\pack.7zf"=>"%Spath%:\FirPE\Resource\%w:~1,-2%"
if not exist "%Spath%:\FirPE\Resource\%w:~1,-2%" echo %time% ept-install-保存到U盘服务-保存失败 >>X:\Users\Log.txt
if exist "%Spath%:\FirPE\Resource\%w:~1,-2%" echo %time% ept-install-保存到U盘服务-保存成功 >>X:\Users\Log.txt
if exist "%Spath%:\FirPE\Resource\%w:~1,-2%" echo ept-install 已将%w:~1,-2%保存至%Spath%盘
if not exist "%Spath%:\FirPE\Resource\%w:~1,-2%" (
